# PWA Icon Generator - Clean version (white background)
# Creates clean icons without colored borders
...
Write-Host "PWA Icon Generator - Clean version" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Generating icons (white background, full size)..." -ForegroundColor Green
...
foreach ($size in $sizes) {
    ...
    try {
        ...
        # Draw icon at full size (no padding)
