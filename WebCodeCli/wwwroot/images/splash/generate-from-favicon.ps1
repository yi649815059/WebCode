# PWA Splash Screen Generator - from favicon.ico
# Creates splash screens for iOS devices
...
Write-Host "PWA Splash Screen Generator" -ForegroundColor Cyan
...
foreach ($screen in $splashScreens) {
    ...
    try {
        ...
        $scale = [Math]::Min($logoSize / $source.Width, $logoSize / $source.Height)
